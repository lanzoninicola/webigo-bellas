...
class Webigo
{
	...
	private function add_modules()
	{
		...
		require_once WEBIGO_PLUGIN_PATH . '/modules/header-menu/settings/class-webigo-header-menu-settings.php';

		$this->modules_registry->register(
			Webigo_Header_Menu_Settings::MODULE_NAME,
			Webigo_Header_Menu_Settings::BOOTSTRAP_CLASS_NAME,
			Webigo_Header_Menu_Settings::MODULE_FOLDER,
			Webigo_Header_Menu_Settings::BOOTSTRAP_CLASS_FILENAME,
		);
